    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type",
                    models.CharField(
                        choices=[("start", "출발 비스"), ("final", "최종 비스")],
                        max_length=10,
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("obtained_week", models.PositiveIntegerField(blank=True, null=True)),
                (
                    "gearset",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "floor",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="core.raidfloor"
                    ),
                ),
            ],
        ),
